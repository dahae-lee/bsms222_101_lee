---
title: "Chapter 13. Probability_2017250101"
...
When two events, say A and B, are independent, we have: Pr(A∣B)=Pr(A)
...
```{r}
B <- 10000
celtic_hav_wins <- function(){
  celtic_wins <- sample(c(0,1), 4, replace = TRUE, prob = c(0.6, 0.4))
  any(celtic_wins %in% "1")
}
events <- replicate(B, celtic_hav_wins())
mean(events)
```

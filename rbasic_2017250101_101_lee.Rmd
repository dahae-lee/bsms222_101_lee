---
title: "rbasic_2017250101_101_lee"
...
in Rstudio, we could see value "a","b" and "c".  If you try to recover the value of a variable that is not in your workspace, you receive an error. For example, if you type x you will receive the following message: Error: object 'x' not found.
